...
public class ClosedBezierController {
    ...
    private void initialize() {
        ...
        this.center =
            Bindings.createObjectBinding(() -> new Point2D(this.root.getWidth() / 2.0, this.root.getHeight() / 2.0),
        ...
        final var circlePoint1 =
            ClosedBezierController.drawPoint(point1, ClosedBezierController.POINT_CSS, this.pointsVisible);
        final var circlePoint2 =
            ClosedBezierController.drawPoint(point2, ClosedBezierController.POINT_CSS, this.pointsVisible);
        final var circlePoint3 =
            ClosedBezierController.drawPoint(point3, ClosedBezierController.POINT_CSS, this.pointsVisible);
        final var circlePoint4 =
            ClosedBezierController.drawPoint(point4, ClosedBezierController.POINT_CSS, this.pointsVisible);
        ...
        // region Lines
        final var line12 = ClosedBezierController.drawLine(point1,
                                                           point2,
                                                           ClosedBezierController.POLYGON_LINE_CSS,
                                                           this.polygonVisible);
        final var line23 = ClosedBezierController.drawLine(point2,
                                                           point3,
                                                           ClosedBezierController.POLYGON_LINE_CSS,
                                                           this.polygonVisible);
        final var line34 = ClosedBezierController.drawLine(point3,
                                                           point4,
                                                           ClosedBezierController.POLYGON_LINE_CSS,
                                                           this.polygonVisible);
        final var line41 = ClosedBezierController.drawLine(point4,
                                                           point1,
                                                           ClosedBezierController.POLYGON_LINE_CSS,
                                                           this.polygonVisible);
        ...
        Stream.of(control1, control2, control3, control4)
              ...
              .map(point -> ClosedBezierController.drawPoint(point,
                                                             ClosedBezierController.CONTROL_POINT_CSS,
                                                             this.controlsVisible))
              .forEach(this.root.getChildren()::add);

        Stream.of(control1, control2, control3, control4)
              .map(points -> ClosedBezierController.drawLine(points[0],
                                                             points[1],
    ...
    private static Circle drawPoint(final PolarPoint point,
    ...
    private static Line drawLine(final PolarPoint start,
    ...
    private Line drawRadius(final PolarPoint end) {
        ...
        line.startXProperty().bind(Bindings.createDoubleBinding(() -> this.center.get().getX(), this.center));
        line.startYProperty().bind(Bindings.createDoubleBinding(() -> this.center.get().getY(), this.center));
        line.endXProperty().bind(end.xProperty());
        line.endYProperty().bind(end.yProperty());
